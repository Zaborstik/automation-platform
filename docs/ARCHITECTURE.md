...
> **Документ:** архитектура монорепозитория и связей между модулями.  
> **К чему относится:** все Java-модули, БД Flyway, HTTP API; дополняет [`CORE-DETAILED-LOGIC-WITH-EXAMPLES.md`](CORE-DETAILED-LOGIC-WITH-EXAMPLES.md).
