...
/**
 * Lightweight summary of a plan execution returned to the local executor when
 * it starts/finishes a run. Replaces the old {@code ExecutePlanResponse},
 * which was tied to server-side browser execution.
 */
public class PlanRunResponse {
